...
func (_q *LinkCategoryQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *LinkCategoryQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *LinkCategoryQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *LinkCategoryQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *LinkCategoryQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *LinkCategoryQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(linkcategory.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.LinkCategory.Query().
//		Select(linkcategory.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *LinkCategoryQuery) loadLinks(ctx context.Context, query *LinkQuery, nodes []*LinkCategory, init func(*LinkCategory), assign func(*LinkCategory, *Link)) error {
	...
	nodeids := make(map[uint]*LinkCategory)
	for i := range nodes {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(link.FieldCategoryID)
	}
...
func (_q *LinkCategoryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(linkcategory.Table, linkcategory.Columns, sqlgraph.NewFieldSpec(linkcategory.FieldID, field.TypeUint))
	_spec.From = _q.sql
...
func (_q *LinkCategoryQuery) ForUpdate(opts ...sql.LockOption) *LinkCategoryQuery {
...
func (_q *LinkCategoryQuery) ForShare(opts ...sql.LockOption) *LinkCategoryQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
