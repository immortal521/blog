...
type PostQuery struct {
	...
	withCategories            *PostCategoryQuery
	withTags                  *PostTagQuery
	withPostCategoryRelations *PostCategoryRelationQuery
	withPostTagRelations      *PostTagRelationQuery
...
func (_q *PostQuery) QueryCategories() *PostCategoryQuery {
...
func (_q *PostQuery) QueryTags() *PostTagQuery {
...
func (_q *PostQuery) QueryPostCategoryRelations() *PostCategoryRelationQuery {
...
// QueryPostTagRelations chains the current query on the "post_tag_relations" edge.
func (_q *PostQuery) QueryPostTagRelations() *PostTagRelationQuery {
	query := (&PostTagRelationClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *PostQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *PostQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *PostQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *PostQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *PostQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *PostQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PostQuery) Clone() *PostQuery {
	...
	return &PostQuery{
		...
		withPostTagRelations:      _q.withPostTagRelations.Clone(),
...
func (_q *PostQuery) WithCategories(opts ...func(*PostCategoryQuery)) *PostQuery {
	query := (&PostCategoryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PostQuery) WithTags(opts ...func(*PostTagQuery)) *PostQuery {
	query := (&PostTagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PostQuery) WithPostCategoryRelations(opts ...func(*PostCategoryRelationQuery)) *PostQuery {
	query := (&PostCategoryRelationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithPostTagRelations tells the query-builder to eager-load the nodes that are connected to
// the "post_tag_relations" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *PostQuery) WithPostTagRelations(opts ...func(*PostTagRelationQuery)) *PostQuery {
	query := (&PostTagRelationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withPostTagRelations = query
	return _q
}
...
func (_q *PostQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Post, error) {
	...
	if query := _q.withCategories; query != nil {
		if err := _q.loadCategories(ctx, query, nodes,
			func(n *Post) { n.Edges.Categories = []*PostCategory{} },
			func(n *Post, e *PostCategory) { n.Edges.Categories = append(n.Edges.Categories, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTags; query != nil {
		if err := _q.loadTags(ctx, query, nodes,
			func(n *Post) { n.Edges.Tags = []*PostTag{} },
			func(n *Post, e *PostTag) { n.Edges.Tags = append(n.Edges.Tags, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withPostCategoryRelations; query != nil {
		if err := _q.loadPostCategoryRelations(ctx, query, nodes,
			func(n *Post) { n.Edges.PostCategoryRelations = []*PostCategoryRelation{} },
			func(n *Post, e *PostCategoryRelation) {
				n.Edges.PostCategoryRelations = append(n.Edges.PostCategoryRelations, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := _q.withPostTagRelations; query != nil {
		if err := _q.loadPostTagRelations(ctx, query, nodes,
			func(n *Post) { n.Edges.PostTagRelations = []*PostTagRelation{} },
			func(n *Post, e *PostTagRelation) { n.Edges.PostTagRelations = append(n.Edges.PostTagRelations, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PostQuery) loadCategories(ctx context.Context, query *PostCategoryQuery, nodes []*Post, init func(*Post), assign func(*Post, *PostCategory)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[uint]*Post)
	nids := make(map[uint]map[*Post]struct{})
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(postcategory.FieldID), joinT.C(post.CategoriesPrimaryKey[1]))
...
func (_q *PostQuery) loadTags(ctx context.Context, query *PostTagQuery, nodes []*Post, init func(*Post), assign func(*Post, *PostTag)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[uint]*Post)
	nids := make(map[uint]map[*Post]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(posttag.FieldID), joinT.C(post.TagsPrimaryKey[1]))
...
func (_q *PostQuery) loadPostCategoryRelations(ctx context.Context, query *PostCategoryRelationQuery, nodes []*Post, init func(*Post), assign func(*Post, *PostCategoryRelation)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(postcategoryrelation.FieldPostID)
	}
	query.Where(predicate.PostCategoryRelation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(post.PostCategoryRelationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *PostQuery) loadPostTagRelations(ctx context.Context, query *PostTagRelationQuery, nodes []*Post, init func(*Post), assign func(*Post, *PostTagRelation)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*Post)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.PostTagRelation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(post.PostTagRelationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
