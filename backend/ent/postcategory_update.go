...
func (_u *PostCategoryUpdate) SetNillableUpdatedAt(v *time.Time) *PostCategoryUpdate {
	if v != nil {
		_u.SetUpdatedAt(*v)
	}
	return _u
...
// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (_u *PostCategoryUpdateOne) SetNillableUpdatedAt(v *time.Time) *PostCategoryUpdateOne {
	if v != nil {
		_u.SetUpdatedAt(*v)
	}
	return _u
