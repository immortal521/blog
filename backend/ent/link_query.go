...
func (_q *LinkQuery) QueryCategory() *LinkCategoryQuery {
	query := (&LinkCategoryClient{config: _q.config}).Query()
...
func (_q *LinkQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *LinkQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *LinkQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *LinkQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *LinkQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *LinkQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *LinkQuery) WithCategory(opts ...func(*LinkCategoryQuery)) *LinkQuery {
	query := (&LinkCategoryClient{config: _q.config}).Query()
...
func (_q *LinkQuery) loadCategory(ctx context.Context, query *LinkCategoryQuery, nodes []*Link, init func(*Link), assign func(*Link, *LinkCategory)) error {
	ids := make([]uint, 0, len(nodes))
	nodeids := make(map[uint][]*Link)
	for i := range nodes {
...
func (_q *LinkQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(link.Table, link.Columns, sqlgraph.NewFieldSpec(link.FieldID, field.TypeUint))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withCategory != nil {
			_spec.Node.AddColumnOnce(link.FieldCategoryID)
		}
	}
