...
func (_c *PostTagCreate) AddPostIDs(ids ...uint) *PostTagCreate {
	_c.mutation.AddPostIDs(ids...)
	return _c
}

// AddPosts adds the "posts" edges to the Post entity.
func (_c *PostTagCreate) AddPosts(v ...*Post) *PostTagCreate {
	ids := make([]uint, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *PostTagCreate) check() error {
	...
	if _, ok := _c.mutation.Slug(); !ok {
		return &ValidationError{Name: "slug", err: errors.New(`ent: missing required field "PostTag.slug"`)}
	}
